...
function getIndices() {
  return axios.get(INDICES_WATCH_URL).catch((error) => { throw new ExpressError(error); });
}

function getSectorsList() {
  return axios.get(SECTORS_LIST).catch((error) => { throw new ExpressError(error); });
}
...
function getQuotes(symbol) {
  return axios.get(GET_QUOTE_URL + encodeURIComponent(symbol),
    ...
    }).catch((error) => { throw new ExpressError(error); })
}
...
function getGainers() {
  return axios.get(GAINERS_URL).catch((error) => { throw new ExpressError(error); })
}

function getLosers() {
  return axios.get(LOSERS_URL).catch((error) => { throw new ExpressError(error); })
}

function getInclineDecline() {
  return axios.get(ADVANCES_DECLINES_URL).catch((error) => { throw new ExpressError(error); })
}

function getIndexStocks(slug) {
  return axios.get(INDEX_STOCKS_URL + encodeURI(slug) + 'StockWatch.json').catch((error) => { throw new ExpressError(error); })
}
...
function getIntraDayData(symbol, time) {
  ...
  return axios.get(INTRADAY_URL + encodeURIComponent(symbol) + '&Periodicity=' + period + '&PeriodType=' + periodType).catch((error) => { throw new ExpressError(error); })
}
...
function getIndexChartData(symbol, time) {
  ...
  return axios.get(INDEX_CHARTDATA_URL + encodeURIComponent(symbol) + '&Periodicity=' + period + '&PeriodType=' + periodType).catch((error) => { throw new ExpressError(error); });
}
...
function searchStocks(searchString) {
  ...
  return axios.get(SEARCH_URL + encodeURIComponent(searchString), options).catch((error) => { throw new ExpressError(error); });
}
